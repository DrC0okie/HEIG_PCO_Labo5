...
\begin{document}
    ...
    Because the mutex is systematically unlocked before the animation and re-locked afterwards, this mechanisms disrupts the synchronization flow, as the order of the execution is different before and after the animation.
    % TODO: what does the last sentence mean?
